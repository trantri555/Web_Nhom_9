...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Xử lý ĐĂNG KÝ: Chuyển hướng về index.html
    if (registerForm) {
        registerForm.addEventListener("submit", function (e) {
            e.preventDefault();
            // LƯU TRẠNG THÁI ĐÃ ĐĂNG NHẬP sau khi đăng ký thành công
            localStorage.setItem('isLoggedIn', 'true');
            updateAuthUI(true); // Cập nhật UI ngay trên trang login
            alert("Đăng ký thành công! Bạn sẽ được chuyển về Trang Chủ.");
