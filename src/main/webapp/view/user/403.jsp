    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <head>
                ...
                <title>403 - Không Có Quyền Truy Cập - Juicy</title>
            ...
            <body>
                ...
                <main class="error-container">
                    ...
                    <p class="error-message">Ôi không! Bạn không đủ quyền truy cập trang này.</p>
                    <p class="error-description">
                        Rất tiếc, Bạn không đủ quyền để truy cập vào trang quản trị.
