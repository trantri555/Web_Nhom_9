        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-semibold" href="${pageContext.request.contextPath}/about">Giới thiệu</a>
                    </li>
                    <li class="nav-item">
...
<section class="container py-5">
    <div class="row align-items-center gy-5">
        ...
        <div class="col-md-6">
            ...
            <p>Chúng tôi mang đến nguồn dinh dưỡng từ thiên nhiên, giúp bạn duy trì lối sống lành mạnh. Mỗi sản phẩm
                Juicy được chọn lọc kỹ lưỡng, từ nguyên liệu tươi ngon đến quy trình ép lạnh giữ trọn dưỡng chất.</p>
            <ul class="list-unstyled">
                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Nguyên liệu tươi đạt chuẩn GlobalGAP</li>
                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Cold-press giữ nguyên vitamin &amp; enzyme
                </li>
                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Không phẩm màu, không chất bảo quản</li>
            </ul>
        </div>
    </div>
    <!-- Đội ngũ -->
    <div class="row align-items-center gy-5">
        ...
        <div class="col-md-6 order-md-1">
            ...
            <p>
                Chúng tôi là một tập thể trẻ, năng động, đam mê sức khỏe và yêu thiên nhiên. Mỗi thành viên của Juicy
...
<section class="bg-light py-5">
    <div class="container">
        ...
        <p class="text-center mb-5">Juicy ra đời với tầm nhìn mang trái cây tươi ngon &amp; nước ép chất lượng cao đến
            mọi gia đình Việt Nam. Bắt đầu từ một cửa hàng nhỏ, đến nay chúng tôi đã phục vụ hàng ngàn khách hàng mỗi
            ngày.</p>
